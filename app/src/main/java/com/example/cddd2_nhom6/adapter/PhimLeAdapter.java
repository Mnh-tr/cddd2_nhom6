...
public class PhimLeAdapter extends RecyclerView.Adapter<PhimLeAdapter.DSPhimViewHolder>{
    ...
    public PhimLeAdapter(Context context) {
    ...
    // Constructor
    public PhimLeAdapter(Activity context, List<DSPhim> dsPhims) {
    ...
    public void setRecyclerViewItemClickListener(OnRecyclerViewItemClickListener recyclerViewItemClickListener) {
        PhimLeAdapter.recyclerViewItemClickListener = recyclerViewItemClickListener;
    }
