...
public class QuocGiaLocAdapter extends RecyclerView.Adapter<QuocGiaLocAdapter.DSPhimViewHolder>{
    ...
    public QuocGiaLocAdapter(Context context) {
    ...
    // Constructor
    public QuocGiaLocAdapter(Activity context, List<DSPhim> dsPhims) {
    ...
    public void setRecyclerViewItemClickListener(OnRecyclerViewItemClickListener recyclerViewItemClickListener) {
        QuocGiaLocAdapter.recyclerViewItemClickListener = recyclerViewItemClickListener;
    }
