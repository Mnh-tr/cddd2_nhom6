...
public class PhimBoAdapter extends RecyclerView.Adapter<PhimBoAdapter.DSPhimViewHolder>{
    ...
    public PhimBoAdapter(Context context) {
    ...
    // Constructor
    public PhimBoAdapter(Activity context, List<DSPhim> dsPhims) {
    ...
    public void setRecyclerViewItemClickListener(OnRecyclerViewItemClickListener recyclerViewItemClickListener) {
        PhimBoAdapter.recyclerViewItemClickListener = recyclerViewItemClickListener;
    }
