...
public class PhimHoatHinhAdapter extends RecyclerView.Adapter<PhimHoatHinhAdapter.DSPhimViewHolder>{
    ...
    public PhimHoatHinhAdapter(Context context) {
    ...
    // Constructor
    public PhimHoatHinhAdapter(Activity context, List<DSPhim> dsPhims) {
    ...
    public void setRecyclerViewItemClickListener(OnRecyclerViewItemClickListener recyclerViewItemClickListener) {
        PhimHoatHinhAdapter.recyclerViewItemClickListener = recyclerViewItemClickListener;
    }
